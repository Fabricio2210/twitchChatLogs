<template>
  <div class="py-1">
    <b-navbar class="bgnav bordanav" fixed="top" toggleable="lg" type="light" variant="info">
      <b-navbar-brand class="titulo"><h3 class="fontTitulo"> ARCHIVE CHAT LOGS <v-icon name="file-archive" scale="3" class="mb-3 ml-1"/></h3></b-navbar-brand>
...
<style scoped>
    ...
    .bgnav{
     ...
     .titulo{
      ...
      font-weight: bold;
      text-shadow: 0px 0px 0 rgb(58,23,122),
